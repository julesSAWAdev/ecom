...
<body>
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-12">
                    <a href="adduser" style="color: #fff"><button type="button" class="btn btn-primary btn-lg" style="float: right"><i class='fa fa-plus'></i> Add a user</button></a>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>A list of all system users</h5>
